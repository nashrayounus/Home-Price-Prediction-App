...
path = "/content/drive/MyDrive/IDX Group Folder (ds32)/Models/xgb_best.joblib"

# -----------------------------
# Load model and columns
# -----------------------------
model_path = "/content/model.pkl"  # adjust path if needed
columns_path = "/content/drive/MyDrive/IDX Group Folder (ds32)/Models/columns.json"  # adjust path if needed
